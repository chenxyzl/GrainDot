...
namespace ExcelMapper.Readers
{
    ...
    public abstract class SplitCellValueReader : IMultipleCellValuesReader
    {
        ...
        public bool TryGetValues(ExcelSheet sheet, int rowIndex, IExcelDataReader reader, out IEnumerable<ReadCellValueResult> result, MemberInfo member)
        {
            ...
            result = splitStringValues.Select(s => new ReadCellValueResult(readResult.ColumnIndex, readResult.ColumnName, s));
            return true;
        }
