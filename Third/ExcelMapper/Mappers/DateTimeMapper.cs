...
public class DateTimeMapper : ICellValueMapper
{
    ...
    public string[] Formats
    {
        ...
        set
        {
            ...
            if (value.Length == 0) throw new ArgumentException("Formats cannot be empty.", nameof(value));
    ...
    public CellValueMapperResult MapCellValue(ReadCellValueResult readResult)
    {
        try
        {
            var result = DateTime.ParseExact(readResult.StringValue, Formats, Provider, Style);
