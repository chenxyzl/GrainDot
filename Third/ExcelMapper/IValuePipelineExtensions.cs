...
public static class IValuePipelineExtensions
{
    ...
    /// <param name="propertyMap">The property map to use.</param>
    /// <param name="mappers">
    ///     A list of additional custom mappers that will be used to map the value of a cell to a property or
    ///     field
    /// </param>
    /// <returns>The property map on which this method was invoked.</returns>
    public static TPropertyMap WithCellValueMappers<TPropertyMap>(this TPropertyMap propertyMap,
        params ICellValueMapper[] mappers) where TPropertyMap : IValuePipeline
    {
        ...
        foreach (var mapper in mappers) propertyMap.AddCellValueMapper(mapper);
    ...
    /// <param name="comparer">
    ///     The comparer uses to map fixed string values. This allows for case-insensitive mappings, for
    ///     example.
    /// </param>
    /// <returns>The property map on which this method was invoked.</returns>
    public static TPropertyMap WithMapping<TPropertyMap, T>(this TPropertyMap propertyMap,
        IDictionary<string, T> mappingDictionary, IEqualityComparer<string> comparer = null)
    ...
    /// <returns>The property map on which this method was invoked.</returns>
    public static IValuePipeline<DateTime> WithDateFormats(this IValuePipeline<DateTime> propertyMap,
    ...
    private static void AddFormats(this IValuePipeline propertyMap, string[] formats)
    {
        ...
        if (formats.Length == 0) throw new ArgumentException("Formats cannot be empty.", nameof(formats));

        var dateTimeItem =
            (DateTimeMapper) propertyMap.CellValueMappers.FirstOrDefault(item => item is DateTimeMapper);
    ...
    ///     A delegate that is invoked to map the string value of a cell to the value of a property or
    ///     field.
    /// </param>
    /// <returns>The property map on which this method was invoked.</returns>
    public static TPropertyMap WithConverter<TPropertyMap, T>(this TPropertyMap propertyMap,
        ConvertUsingSimpleMapperDelegate<T> converter) where TPropertyMap : IValuePipeline<T>
    {
        if (converter == null) throw new ArgumentNullException(nameof(converter));

        ConvertUsingMapperDelegate actualConverter = readResult =>
        {
            try
            {
    ...
    public static TPropertyMap WithConverter<TPropertyMap>(this TPropertyMap propertyMap,
        ConvertUsingMapperDelegate converter) where TPropertyMap : IValuePipeline
    {
        if (converter == null) throw new ArgumentNullException(nameof(converter));
    ...
    ///     The value that will be assigned to the property or field if the value of a cell is empty or
    ///     cannot be mapped.
    /// </param>
    /// <returns>The property map on which this method was invoked.</returns>
    public static TPropertyMap WithValueFallback<TPropertyMap>(this TPropertyMap propertyMap, object defaultValue)
        where TPropertyMap : IValuePipeline
    {
        return propertyMap
    ...
    /// <param name="propertyMap">The property map to use.</param>
    /// <returns>The property map on which this method was invoked.</returns>
    public static TPropertyMap WithThrowingFallback<TPropertyMap>(this TPropertyMap propertyMap)
        where TPropertyMap : IValuePipeline
    {
        return propertyMap
    ...
    /// <returns>The property map on which this method was invoked.</returns>
    public static TPropertyMap WithEmptyFallback<TPropertyMap>(this TPropertyMap propertyMap, object fallbackValue)
        where TPropertyMap : IValuePipeline
    {
        return propertyMap
    ...
    /// <returns>The property map on which this method was invoked.</returns>
    public static TPropertyMap WithEmptyFallbackItem<TPropertyMap>(this TPropertyMap propertyMap,
        IFallbackItem fallbackItem) where TPropertyMap : IValuePipeline
    {
    ...
    /// <param name="propertyMap">The property map to use.</param>
    /// <returns>The property map on which this method was invoked.</returns>
    public static TPropertyMap WithThrowingEmptyFallback<TPropertyMap>(this TPropertyMap propertyMap)
        where TPropertyMap : IValuePipeline
    {
        return propertyMap
    ...
    /// <param name="propertyMap">The property map to use.</param>
    /// <returns>The property map on which this method was invoked.</returns>
    public static TPropertyMap WithThrowingInvalidFallback<TPropertyMap>(this TPropertyMap propertyMap)
        where TPropertyMap : IValuePipeline
    {
        return propertyMap
    ...
    ///     The value that will be assigned to the property or field if the value of a cell cannot be
    ///     mapped.
    /// </param>
    /// <returns>The property map on which this method was invoked.</returns>
    public static TPropertyMap WithInvalidFallback<TPropertyMap>(this TPropertyMap propertyMap,
        object fallbackValue) where TPropertyMap : IValuePipeline
    {
        return propertyMap
    ...
    /// <returns>The property map on which this method was invoked.</returns>
    public static TPropertyMap WithInvalidFallbackItem<TPropertyMap>(this TPropertyMap propertyMap,
        IFallbackItem fallbackItem) where TPropertyMap : IValuePipeline
    {
