...
public class RefArrayAccessUtil
{
    ...
    public static void SpElement<T>(T[] buffer, long offset, T e)
    {
        buffer[offset] = e;
    }
    ...
    /// <param name="offset">Computed via <see cref="ConcurrentCircularArrayQueue{T}.CalcElementOffset" /></param>
    /// <param name="e"></param>
    public static void SoElement<T>(T[] buffer, long offset, T e) where T : class
    {
    ...
    public static T LpElement<T>(T[] buffer, long offset)
    {
    ...
    /// <param name="offset">Computed via <see cref="ConcurrentCircularArrayQueue{T}.CalcElementOffset" /></param>
    /// <returns>The element at the given <paramref name="offset" /> in the given <paramref name="buffer" />.</returns>
    public static T LvElement<T>(T[] buffer, long offset) where T : class
    {
