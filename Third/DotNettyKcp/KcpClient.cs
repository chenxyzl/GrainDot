...
public class KcpClient
{
    ...
    {
        if (localAddress == null) localAddress = new IPEndPoint(IPAddress.Any, 0);
    ...
    public Ukcp connect(IChannel localChannel, EndPoint remoteAddress, ChannelConfig channelConfig,
    ...
    /**
         * 连接一个服务器
         */
    public Ukcp connect(EndPoint localAddress, EndPoint remoteAddress, ChannelConfig channelConfig,
        KcpListener kcpListener)
    {
