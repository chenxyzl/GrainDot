...
namespace Base.Network
{
    ...
    /// websocket链接的虚类
    /// </summary>
    public abstract class WebSocketConnection : BaseTcpSocketConnection<IWebSocketServer, IWebSocketConnection, byte[]>, IWebSocketConnection
    {
        #region 构造函数
        /// <summary>
        /// 构造函数
        ...
        public WebSocketConnection(IWebSocketServer server, IChannel channel, TcpSocketServerEvent<IWebSocketServer, IWebSocketConnection, byte[]> serverEvent)
