...
namespace Base.Network.Shared
{
    ...
    public class BufferReader : IBufferReader, IDisposable
    {
        ...
        /// <summary>
        /// Creates a new instance of a <see cref="BufferReader"/>.
        /// </summary>
        ...
        public static BufferReader Create(byte[] bytes, int dataOffset, int dataLength)
        {
            var reader = PoolManager.bufferReader;
        ...
        public void Dispose()
        {
            PoolManager.DisposebufferReader(this);
            Dispose(true);
