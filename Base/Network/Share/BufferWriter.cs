...
namespace Base.Network.Shared
{
    ...
    /// </summary>
    public class BufferWriter : IBufferWriter, IDisposable
    {
        ...
        /// <summary>
        /// Creates a new instance of a <see cref="BufferWriter"/>.
        /// </summary>
        internal BufferWriter() { }
        ...
        public static BufferWriter Create(Encoding encoding)
        {
        ...
        /// </summary>
        /// <param name="capacity">The initial capacity value of buffer.</param>
        public static BufferWriter Create(int initialCapacity)
        {
        ...
        /// <param name="capacity">The initial capacity value of buffer.</param>
        /// <param name="encoding">The encoding value to write char array in the buffer.</param>
        public static BufferWriter Create(int initialCapacity, Encoding encoding)
        {
            var writer = PoolManager.BufferWriter;
        ...
        public void Dispose()
        {
            PoolManager.DisposeBufferWriter(this);
            Dispose(true);
