...
namespace Base.Network.Server
{
    ...
    /// </summary>
    public class WSSession<A> : Session<A> where A : BaseActor
    {
        ...
        /// <summary>
        /// Creates a new instance of a <see cref="WSSession"/>.
        /// </summary>
        ...
        public WSSession(ushort id, string remoteEndPoint, NetworkListenerType listenerType, WebSocket ws, HttpListenerContext listenerContext, MessageReceivedHandler messageReceivedHandler, ClientDisconnectedHandler clientDisconnectedHandler, ushort maxMessageBuffer)
        {
            try
            {
