...
{
    /// <summary>
    /// This class is responsible for management of client.
    /// </summary>
    public class Client
    {
        ...
        public delegate void ClientPacketHandler(IBufferReader reader);
        ...
        /// </summary>
        /// <param name="writer">The buffer writer to send message.</param>
        public void SendMessage(IBufferWriter writer)
        {
            try
            {
