...
public partial class RpcItemMessage
{
    public static List<RpcItem> rpcItemsOuter = new()
    {
        ...
        new(200004, OpType.S, null, typeof(SLoginElsewhere), "LoginElsewhere"),
        new(200100, OpType.S, null, typeof(SSyncReward), "SyncReward"),
        new(200101, OpType.CS, typeof(C2SMails), typeof(S2SMails), "GetMails")
    };
}