...
public class LoginKeyComponent : IGlobalComponent
{
    ...
    private readonly Dictionary<string, IActorRef> loginKeys = new();
    private readonly Dictionary<IActorRef, string> loginRefs = new();
    private readonly Random random = new();
    private readonly SortedDictionary<long, string> timeKeys = new();
    ...
    public string AddPlayerRef(IActorRef playerRef)
    {
        lock (lockObj)
        {
            while (true)
            {
                ...
                if (loginKeys[key] != null) continue;
